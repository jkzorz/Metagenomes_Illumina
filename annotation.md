...
```
**Latest DRAM run can be found at:
/work/ebg_lab/gm/gapp/jzorz/Metagenomes_Illumina/dereplicated_genomes/
with copy here: 
/work/ebg_lab/gm/gapp/jzorz/Metagenomes_Illumina/binning/dastool/drep_dastool_out2/dereplicated_genomes_Good_Bins_CheckM2/drep_Final_Nanopore_output/dereplicated_genomes**
...
```
hmmsearch --noali --incE 1e-50 -E 1e-50 -o plastic_hmms2.out --tblout plastic_hmms2.tblout Dataset_HMMs.hmm ../concatenated_genes.faa  
```
